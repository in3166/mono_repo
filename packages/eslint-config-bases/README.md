...
```bash
$ yarn add --dev eslint @ijyu-3166/eslint-config-bases
```
...
module.exports = {
  ...
  extends: [
    ...
    // "@ijyu-3166/eslint-config-bases/prettier-config",
  ],
  rules: {
...
> **Tip:**
>
> - **Prettier**: `@ijyu-3166/eslint-config-bases/prettier-plugin` and `@ijyu-3166/eslint-config-bases/prettier-config` are
...
- `@ijyu-3166/eslint-config-bases/prettier-plugin` - eslint will run prettier under the hood
- `@ijyu-3166/eslint-config-bases/prettier-config` - eslint will just disable some conflicting rules (so you'll need to run prettier after)
