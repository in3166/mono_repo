...
> Note: Be sure to create a [.dockerignore containing at least those entries](https://github.com/in3166/mono_repo/blob/main/.dockerignore).
...
See the latest [./docker-compose.nextjs-app.yml](https://github.com/in3166/mono_repo/blob/main/docker-compose.nextjs-app.yml)
and [./Dockerfile](https://github.com/in3166/mono_repo/blob/main/docker-compose.nextjs-app.yml).
